...
<img src="https://raw.githubusercontent.com/RodzMoraes/curso-ebac/main/Media/ebac_logo_black.png" alt="ebac-logo" width=70%>
</div>

# **Profissão: Cientista de Dados**
### [**Projeto #02** | Previsão de renda](https://github.com/RodzMoraes/curso-ebac/tree/main)
...
st.markdown('# <div style="text-align:center"> [Previsão de renda](https://github.com/RodzMoraes/curso-ebac/tree/main) </div>',
            unsafe_allow_html=True)
