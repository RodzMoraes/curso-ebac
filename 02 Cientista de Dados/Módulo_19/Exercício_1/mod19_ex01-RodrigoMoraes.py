...
def main():
    st.set_page_config(
        ...
        page_icon="https://raw.githubusercontent.com/RodzMoraes/curso-ebac/main/M%C3%B3dulo_19/Exerc%C3%ADcio_1/img/telmarketing_icon.png",
        layout="wide",
        initial_sidebar_state="expanded",
    )

    # SIDEBAR
    image = Image.open(fp='Módulo_19/Exercício_1/img/Bank-Branding.jpg')
    st.sidebar.image(image=image)

    # TÍTULO
    st.markdown('''
    <div style="text-align:center">
        <a href="https://github.com/RodzMoraes/curso-ebac">
            <img src="https://raw.githubusercontent.com/RodzMoraes/curso-ebac/main/Media/ebac_logo-dt.png" alt="ebac_logo-data_science" width=100%>
        </a>
    </div> 
    ...
    **Data:** 7 de maio de 2023.
    ...
    bank_raw = load_data(
        file_data='https://raw.githubusercontent.com/RodzMoraes/curso-ebac/main/M%C3%B3dulo_19/Exerc%C3%ADcio_1/data/input/bank-additional-full.csv', sep=';')
    bank = bank_raw.copy()
